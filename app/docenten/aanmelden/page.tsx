...
const DAYS = [
  { value: "monday", label: "Maandag 31 augustus" },
  { value: "tuesday", label: "Dinsdag 1 september" },
  { value: "wednesday", label: "Woensdag 2 september" },
  { value: "thursday", label: "Donderdag 3 september" },
  { value: "friday", label: "Vrijdag 4 september" },
]
...
export default function DocentenAanmeldenPage() {
  ...
  const [classes, setClasses] = useState<ClassInfo[]>([
    { id: "1", name: "", studentCount: "", year: "1", previousParticipation: "no", previousVisits: "" },
  ])
  ...
  const handleClassChange = (id: string, field: keyof ClassInfo, value: string) => {
  ...
  const handleSubmit = (e: React.FormEvent) => {
    ...
    alert("Aanmelding succesvol! U ontvangt een bevestigingsmail met het programma voor uw klas(sen).")
  }
  ...
  return (
    <div className="min-h-screen bg-gradient-to-br from-amber-50 via-orange-50 to-rose-50 py-12 px-4">
      <div className="max-w-4xl mx-auto">
        ...
        <Card className="p-8">
          <div className="mb-8">
            <h1 className="text-3xl font-bold mb-2">Aanmelden Docent</h1>
            <p className="text-gray-600">
              Meld uw klas(sen) aan voor de Culturele INTROWEEK MBO 2026 (31 augustus - 4 september 2026)
            </p>
            <p className="text-sm text-orange-600 font-medium mt-2">Deadline: 1 maart 2026</p>
          </div>
          ...
          <form onSubmit={handleSubmit} className="space-y-6">
            ...
            <div className="space-y-4 pt-6 border-t">
              <div className="flex items-center justify-between">
                <h2 className="text-xl font-semibold">Klas Informatie</h2>
              ...
              {classes.map((classInfo, index) => (
                <Card key={classInfo.id} className="p-4 bg-gray-50">
                  <div className="flex items-center justify-between mb-4">
                    <h3 className="font-semibold">Klas {index + 1}</h3>
                    {classes.length > 1 && (
                      <Button
                        type="button"
                        ...
                        {classInfo.previousParticipation === "yes" && (
                          <div>
                            ...
                            <Textarea
                              ...
                              placeholder="Bijv. Rijksmuseum, NEMO, etc."
                              rows={2}
                            />
            ...
            <div className="space-y-4 pt-6 border-t">
              <h2 className="text-xl font-semibold">Programma Voorkeuren</h2>
              ...
              {formData.activityCount === "1" && (
                <div>
                  ...
                  >
                    ...
                    <option value="morning">Ochtend (09:00 - 12:00)</option>
