    ...
    try {
      ...
      const { data: institution, error: institutionError } = await supabase
        ...
        .insert({
          ...
          logo_url: logoUrl,
          visit_address: formData.address,
  ...
  return (
    <div className="min-h-screen bg-gradient-to-br from-pink-50 via-yellow-50 to-blue-50 py-12 px-4">
      <div className="max-w-4xl mx-auto">
        ...
        <Card className="p-8">
          <div className="mb-8">
            <h1 className="text-3xl font-bold mb-2">Aanmelden Culturele Instelling</h1>
            <p className="text-gray-600">
              Meld uw instelling aan voor de Culturele INTROWEEK MBO 2026 (31 augustus - 4 september 2026)
            </p>
            <p className="text-sm text-orange-600 font-medium mt-2">Deadline: 1 januari 2026</p>
          </div>
          ...
          <form onSubmit={handleSubmit} className="space-y-6">
            ...
            <div className="space-y-4 pt-6 border-t">
              <h2 className="text-xl font-semibold">Programma Informatie</h2>
            ...
            <div className="space-y-4 pt-6 border-t">
              <div className="flex items-center gap-2 mb-2">
                ...
                <h2 className="text-xl font-semibold">Beschikbaarheid</h2>
              </div>
