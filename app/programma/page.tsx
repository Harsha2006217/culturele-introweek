...
const mockInstitutions = [
  {
    id: "1",
    name: "Rijksmuseum",
    logo: "/rijksmuseum-logo.jpg",
    address: "Museumstraat 1, Amsterdam Centrum",
    description:
      "Het Rijksmuseum is een Nederlands nationaal museum gewijd aan kunst en geschiedenis in Amsterdam. Het museum werd geopend in 1885 en toont een collectie van meer dan 8000 voorwerpen.",
    activity:
      "Tijdens de INTROWEEK nemen studenten deel aan een interactieve rondleiding door de Nederlandse meesters, gevolgd door een creatieve workshop waarin ze zelf aan de slag gaan met kunst.",
...
const partners = [
  ...
  { name: "Rijksmuseum Amsterdam", url: "https://www.rijksmuseum.nl" },
